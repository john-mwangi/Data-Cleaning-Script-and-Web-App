...
```{r}
tryCatch(expr = read_excel(path = "../Sales/Sep2021.xlsx", sheet = "KK"),
         error = function(e){
           read_excel(path = "../Sales/Sep2021.xlsx")
         })

try(expr = read_excel(path = "../Sales/Sep2021.xlsx", sheet = "KB"),
    silent = TRUE)
```
...
read_sales(filepaths = "../Sales/Sep2021.xlsx")
```
...
now_file <- paste0("Crafted Pizza Data ",now,".xlsx")
